...
class Zip
{
    ...
    public static function createFromManifest(Manifest $manifest, string $pathToZip): self
    {
    ...
    protected static function determineNameOfFileInZip(string $pathToFile, $pathToZip)
    {
     ...
     *
     * @return \Kibb\Backup\Tasks\Backup\Zip
     */
